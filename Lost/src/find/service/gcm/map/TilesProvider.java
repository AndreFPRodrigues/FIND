...
import find.service.gcm.map.web.DownloadTaskFinishedCallback;
import find.service.gcm.map.web.TileDownloadTask;
import find.service.gcm.map.web.WebTilesProvider;
