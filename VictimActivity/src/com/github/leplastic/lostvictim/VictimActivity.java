...
public class VictimActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Uri sentUri = Uri.parse("content://find.service.net.diogomarques.wifioppish.MessagesProvider/sent");
		cr.registerContentObserver(sentUri, true, new ContentObserver(null) {
			...
			public void onChange(boolean selfChange, Uri uri) {
				uri = (uri == null) ? 
						Uri.parse("content://find.service.net.diogomarques.wifioppish.MessagesProvider/sent") :
						uri;
		...
		svcIntent = new Intent("find.service.net.diogomarques.wifioppish.service.LOSTService.START_SERVICE");  
		...
		btnSendMessage.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Uri dest = Uri.parse("content://find.service.net.diogomarques.wifioppish.MessagesProvider/customsend");
		...
		checkLostStatus(Uri.parse("content://find.service.net.diogomarques.wifioppish.MessagesProvider/status"));
	}
	...
	private void checkLostStatus(Uri uri) {
		Cursor c = getContentResolver().query(
				uri == null ? Uri.parse("content://find.service.net.diogomarques.wifioppish.MessagesProvider/status") : uri, null, "", null, "");
