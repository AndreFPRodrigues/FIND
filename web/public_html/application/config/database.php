...
$active_group = (gethostname() == 'softclean-pc' ? 'localhost' : 'fcul');
$active_record = TRUE;

$db['fcul']['hostname'] = 'localhost';
$db['fcul']['username'] = 'lost';
$db['fcul']['password'] = 'oojohpox';
$db['fcul']['database'] = 'lost';
$db['fcul']['dbdriver'] = 'mysql';
$db['fcul']['dbprefix'] = '';
$db['fcul']['pconnect'] = TRUE;
$db['fcul']['db_debug'] = FALSE;
$db['fcul']['cache_on'] = FALSE;
$db['fcul']['cachedir'] = '';
$db['fcul']['char_set'] = 'utf8';
$db['fcul']['dbcollat'] = 'utf8_general_ci';
$db['fcul']['swap_pre'] = '';
$db['fcul']['autoinit'] = TRUE;
$db['fcul']['stricton'] = FALSE;

$db['localhost']['hostname'] = 'localhost';
$db['localhost']['username'] = 'root';
$db['localhost']['password'] = '';
$db['localhost']['database'] = 'wifioppish';
